...
public:
   ...
   // Temporarily comment out ct and other members to check for issues

   // Optionally print out some of the contents to check for invalid pointers
	// Clear the unordered_map properly when there are pointers
